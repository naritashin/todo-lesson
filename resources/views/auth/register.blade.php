                ...
                <div class="panel-body">
                    {!! Form::open(['url' => 'register', 'role' => 'form', 'class' => 'form-horizontal']) !!}
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::input('text', 'name', old('name'), [null, 'class' => 'form-control', 'id' => 'name']) !!}
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                {!! Form::input('password', 'password_confirmation', null, [null, 'class' => 'form-control', 'id' => 'password-confirm']) !!}
